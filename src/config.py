...
parser.add_argument('--conditioning', required=False, action="store_true",
                    help="use concatenation conditioning")
...
parser.add_argument('--d_condition', type=int, default=192,
                    help='condition dimension (if conditioning is used)')
...
if args.full_dataset:
    assert not args.conditioning, "LPD-full has NaN features"
